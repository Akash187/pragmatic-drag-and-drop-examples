...
import Board from './pieces/board-with-new-auto-scroll/board'
import { Column } from './pieces/board-with-new-auto-scroll/column'

export default function NewAutoScrollExample() {
	const [data, setData] = useState<{
		columnMap: ColumnMap
		orderedColumnIds: string[]
	}>(() => getInitialData({ itemsPerColumn: 100 }))
